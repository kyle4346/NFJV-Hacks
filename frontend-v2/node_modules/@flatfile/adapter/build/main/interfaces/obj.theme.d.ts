...
declare type IStyleCSS = Pick<CSSObject, 'backgroundColor' | 'border' | 'borderBottom' | 'borderLeft' | 'borderRadius' | 'borderRight' | 'borderTop' | 'boxShadow' | 'color' | 'fontSize' | 'fontWeight' | 'lineHeight' | 'margin' | 'padding' | 'textAlign'>;
declare type IStyleCSSButton = IStyleCSS & Pick<CSSObject, ':focus' | ':hover' | ':active'>;
interface IStyleCSSSvg {
    fill?: string;
}
declare type IStyleTable = Pick<CSSObject, 'backgroundColor' | 'borderColor' | 'color' | 'fontSize' | 'fontWeight' | 'textAlign'>;
...
declare type IStyleSelect = Pick<CSSObject, 'backgroundColor' | 'border' | 'borderBottom' | 'borderLeft' | 'borderRadius' | 'borderRight' | 'borderTop' | 'boxShadow' | 'color'>;
